...
const RestaurantTransactionsPage = () => {
  ...
  const postReview = async () => {
    try {
      const response = await axios.post(`http://localhost:8800/api/addRestReview/${selectedOrder._id}`, {
        review: reviewText
      });
        ...
        return (
          <div key={order._id} className="order-card shadow-lg p-4 mb-4 flex items-center hover:bg-gray-100 transition duration-300 ease-in-out relative">
            ...
            <div className="w-3/4 flex flex-col">
              <p className="text-lg font-semibold">NGO: {order.ngoName}</p>
              {order.status === 'requested' && (
                <div className="flex mt-2">
                  ...
                  <button
                    ...
                    className="btn btn-red px-4 py-2 rounded-md bg-red-500 hover:bg-red-600 text-white hover:text-white transition duration-300 ease-in-out"
                  >
                    Decline
                  </button>
                </div>
              ...
              {order.status === 'accepted' && (
                <div className="flex mt-2">
                  ...
                  <div className="ml-4">
                    <label className="block text-sm font-medium text-gray-700">Unique Restaurant Code:</label>
                    <div className="flex items-center">
                      ...
                      <button
                        ...
                        onClick={() => {
                          navigator.clipboard.writeText(order.restCode);
              ...
              {canReview && (
                <button
                  ...
                  className="btn btn-blue font-semibold px-4 py-2 rounded-md bg-blue-500 hover:bg-blue-600 text-white hover:text-white transition duration-300 ease-in-out"
                >
                  Review
                </button>
              )}
